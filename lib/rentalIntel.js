...
function shape(l) {
  return { address: l.displayAddress || l.address, postcode: l.postcode || '', rent: l.price || 0, rentLabel: l.priceLabel || '', beds: l.beds || 0, type: l.type || '', agent: l.agent || '', reduced: !!l.reduced, url: l.url || '' };
}
