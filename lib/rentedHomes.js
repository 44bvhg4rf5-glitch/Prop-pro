...
export async function rentedHomesForPostcode(pc, key, { certCap = 160, conc = 6 } = {}) {
...
export async function rentedHomesForArea(postcodes, key, { start = 0, batch = 8, certCap = 120, conc = 6 } = {}) {
